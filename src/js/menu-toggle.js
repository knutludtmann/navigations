(function($) {
    ...
    $('.dropdown-toggle').click(function(e) {
        ...
        _this.html(_this.html() === '<span class="screen-reader-text">Untermenue oeffnen</span>' ? '<span class="screen-reader-text">Untermenue schließen</span>' : '<span class="screen-reader-text">Untermenu oeffnen</span>');
    });
